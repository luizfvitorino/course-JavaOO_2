 ...
 * funcionário autenticável. Esta classe representa o cargo de Gerente dentro do Bytebank.
 *
 * @author Luiz Moreira
 * @since 1.0
 */
public class Gerente
    ...
    /**
     * Constrói um novo {@code Gerente} usando o construtor da classe mãe. Também define o valor do cargo da instância
     * para "Gerente" e cria um {@code Autenticador} que fica atrelado a essa instância.
     */
    ...
    /**
     * Retorna a bonificação do cargo, sendo neste caso o valor padrão adicionado do próprio salário.
     *
     * @return 10% do salário mais o próprio salário
     */
